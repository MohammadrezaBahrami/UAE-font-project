...
})({"iSukY":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "85cd457c3d676c54";
"use strict";
...
},{}],"4OBvF":[function(require,module,exports) {
...
},{"./slider":"9ICf4","./swiper":"8TPxA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./primaryCategory":"6vUMu"}],"9ICf4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Slider {
    ...
    constructor(){
        this._carouselImages.forEach((img, i)=>img.style.transform = `translateX(${100 * i}%)`);
        this._createDots();
        this._goToSlide(0);
        this._activateDot(0);
        ...
        document.addEventListener("keydown", (function(e) {
            e.key === "ArrowRight" && this._nextSlide() || e.key === "ArrowLeft" && this._prevSlide();
        }).bind(this));
    ...
    _activateDot(slide) {
        document.querySelectorAll(`.carousel__dot-btn`).forEach((dot)=>dot.classList.remove("carousel__dot--active"));
        document.querySelector(`.carousel__dot-btn[data-slide="${slide}"]`).classList.add("carousel__dot--active");
    }
    _createDots() {
        this._carouselImages.forEach((_, i)=>{
            this._dotsContainer.insertAdjacentHTML("beforeend", `<button class="carousel__dot-btn" data-slide="${i}"></button>`);
        });
    }
    _goToSlide(slide) {
